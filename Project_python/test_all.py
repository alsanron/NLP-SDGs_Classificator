...
natureShortFilt = prepare_texts(raw_natureShort)
...
model.load_models()
model.test_model(natureShortFilt, sdgs_natureFilt, path_to_plot="", 
                 path_to_excel=paths["out"] + "all_model.xlsx", only_bad=False,
                   score_threshold=3.0,  only_positive=False, filter_low=True)
