...
natureExtra = []; sdgsNatureExtra = []
for sdg, index in zip(sdgs_nature, range(len(sdgs_nature))):
    if 3 in sdg: continue # avoid overfitting with 3
    natureExtra.append(natureShort[index]); sdgsNatureExtra.append(sdg)
